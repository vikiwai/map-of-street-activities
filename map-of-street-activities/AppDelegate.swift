...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func splashScreen() {
        ...
        Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(dismissSplashContoller), userInfo: nil, repeats: false)
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "map_of_street_activities")
